...
public class RegionProc  implements RegionProcInter{
  ...
  public RegionVO readById(String mid) {
    RegionVO regionVO = this.regionDAO.readById(mid);
    return regionVO;
  }

  @Override
  public ArrayList<RegionVO> list() {
    ArrayList<RegionVO> list = this.regionDAO.list();
  ...
  public int delete(int regiono) {
    int cnt = this.regionDAO.delete(regiono);
    return cnt;
  }
  ...
  public ArrayList<RegionVO> list_search_paging(String word, int now_page, int record_per_page) {
    ...
    ArrayList<RegionVO> list=this.regionDAO.list_search_paging(map);
    return list;
  }
...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
  ...
  public int list_search_count(String word) {
    int cnt = this.regionDAO.list_search_count(word);
    return cnt;
  }

  @Override
  public RegionVO read(int regiono) {
    RegionVO regionVO = this.regionDAO.read(regiono);
    return regionVO;
  }
