...
public class AnswerProc implements AnswerProcInter {
 ...
 // 1 페이지 시작 rownum: now_page = 1, (1 - 1) * 10 --> 0
  ...
  public String pagingBox(int movieno, int now_page, String word, String list_file, int search_count,
    ...
    // str.append(" #paging {text-align: center; margin-top: 5px; font-size:
    // 1em;}");
    // str.append(" #paging A:link {text-decoration:none; color:black; font-size:
    // 1em;}");
    // str.append(" #paging A:hover{text-decoration:none; background-color: #FFFFFF;
    // color:black; font-size: 1em;}");
    // str.append(" #paging A:visited {text-decoration:none;color:black; font-size:
    // 1em;}");
