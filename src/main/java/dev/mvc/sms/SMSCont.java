...
public class SMSCont {
  ...
  @PostMapping(value = "/sms/form.do")
  public String find_passwd_proc(AccountVO accountVO, Model model) {
  ...
  public ModelAndView form(String aname, String aid) {
    ...
    ModelAndView mav = new ModelAndView();
    mav.setViewName("th/account/find_aid");
